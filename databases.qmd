...
In real life, it's rare that you'll use `dbReadTable()` because often database tables are too big to fit in memory, and you want to bring back only a subset of the rows and columns.
